...
public class olderimformationActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_olderimformation2);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(olderimformationActivity2.this,homeActivity.class);
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(olderimformationActivity2.this,yuyue.class);
                startActivity(intent);
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(olderimformationActivity2.this,Tips.class);
                startActivity(intent);
                button4.setBackgroundResource(R.drawable.button41);
                button2.setBackgroundResource(R.drawable.button2);
            }
        });
        Button button5=findViewById(R.id.return2);
        ...
        Button button=findViewById(R.id.today_inf4);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(olderimformationActivity2.this,yuyue2.class);
                startActivity(intent);
            }
        });
    }
    ...
    public void returnto(View view) {
        Intent intent =new Intent(olderimformationActivity2.this,quwanchengActivity.class);
        startActivity(intent);
    }

    public void luruxinxi(View view) {
        Intent intent =new Intent(olderimformationActivity2.this,xiugai.class);
        startActivity(intent);
    }
}
